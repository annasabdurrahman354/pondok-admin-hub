        ...
        <SessionProvider>
          <Routes>
            ...
            <Route element={<ProtectedRoute requiredRole="Admin Pondok" />}>
              ...
              <Route path="/pondok/rab/detail/:rabId" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokRABDetail /></div>} />
              <Route path="/pondok/lpj/detail/:lpjId" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokLPJDetail /></div>} />
              <Route path="/pondok/rab/create" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokRABCreate /></div>} />
              <Route path="/pondok/rab/edit/:rabId" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokRAB /></div>} />
              <Route path="/pondok/lpj/create" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokLPJCreate /></div>} />
              <Route path="/pondok/lpj/edit/:lpjId" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokLPJ /></div>} />
              <Route path="/pondok/sync" element={<div className="container mx-auto px-3 py-4 max-w-3xl"><PondokSync /></div>} />
            </Route>
